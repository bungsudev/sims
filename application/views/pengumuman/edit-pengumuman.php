<form action="<?= base_url(); ?>pengumuman/edited" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
<input type="hidden" name="id_pengumuman" value="<?= $detail['id_pengumuman'] ?>">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <div class="mb-3">
                                <img src="<?= base_url('assets/img/pengumuman/'.$detail['images'].''); ?>" alt="" class="img-fluid">
                            </div>
