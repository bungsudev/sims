<form action="<?= base_url(); ?>profil/edited" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
<input type="hidden" name="id_profil" value="<?= $detail['id_profil'] ?>">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control basic-usage" name="page_name" value="<?= $detail['page_name'] ?>" required>
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control text-primary" id="permalink" name="slug" required readonly value="<?= $detail['slug'] ?>">
                            <div class="invalid-feedback">
                                Form tidak boleh kosong!
                            </div>
                        </div>
